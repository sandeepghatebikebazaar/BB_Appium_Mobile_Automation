...
import Pages.LoginPage_page_Fail;
...
public class Productype_Fail extends Base_test_1 {


    LoginPage_page_Fail Log_1;
    JSONObject object;
    @BeforeClass
...
System.out.println("\n"+"***Starting test:"+m.getName()+"****"+"\n");
    ...
    @Test
public void Productype_fail() throws InterruptedException {
Log_1= new LoginPage_page_Fail();
